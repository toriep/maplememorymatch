...
class Game{
    ...
    card_clicked() {
        ...
        if (this.first_card_clicked === null) { //first card clicked
            this.first_card_clicked = $(this)[0].cardDiv;
            debugger;
    ...
    showWinModal(){
        ...
        this.span.onclick = function() {//exit modal when click on x
